public class RCON {
    ...
    public static void main(String[] args) {
        ...
        int[] substitutedWord = substituteWord(rotateWord);
        int[] finalWord = xorWithRcon(substitutedWord, 0); // 0 for the first round

        // Print the rotateWord
        System.out.println("RotateWord:");
        printWord(rotateWord);

        // Print the substituted word
        System.out.println("Substituted Word:");
        printWord(substitutedWord);

        System.out.println("Final Word (after XOR with Rcon):");
        printWord(finalWord);
    }
